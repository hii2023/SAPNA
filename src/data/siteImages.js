...
export const SITE_IMAGE_GROUPS = [
  {
    ...
    items: [
      ...
      { key: 'home_cat_macrame', label: 'Category card: Macrame', desc: '"Four Ways to Bring Handmade Art Home" section, Macrame card.', w: 800, h: 800, url: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=500&q=80' },
      { key: 'home_cat_painting', label: 'Category card: Paintings', desc: '"Four Ways to Bring Handmade Art Home" section, Paintings card.', w: 800, h: 800, url: 'https://images.unsplash.com/photo-1541961017774-22349e4a1262?w=500&q=80' },
      { key: 'home_cat_stitching', label: 'Category card: Stitching', desc: '"Four Ways to Bring Handmade Art Home" section, Stitching card.', w: 800, h: 800, url: 'https://images.unsplash.com/photo-1513519245088-0e12902e5a38?w=500&q=80' },
      { key: 'home_cat_diy', label: 'Category card: DIY Kits', desc: '"Four Ways to Bring Handmade Art Home" section, DIY Kits card.', w: 800, h: 800, url: 'https://images.unsplash.com/photo-1452860606245-08befc0ff44b?w=500&q=80' },
      ...
      { key: 'home_about_secondary', label: 'Meet Sapna: small photo', desc: '"Hello, I\'m Sapna" section on the home page, small overlapping photo.', w: 500, h: 500, url: 'https://images.unsplash.com/photo-1524492412937-b28074a5d7da?w=400&q=80' },

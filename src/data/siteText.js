...
export const SITE_TEXT_GROUPS = [
  {
    ...
    items: [
      ...
      { key: 'home_craft_1', label: 'Hero chip 1: craft name', def: 'Macrame' },
      { key: 'home_craft_2', label: 'Hero chip 2: craft name', def: 'Painting & Mural' },
      { key: 'home_craft_3', label: 'Hero chip 3: craft name', def: 'Home Decor' },
      { key: 'home_craft_4', label: 'Hero chip 4: craft name', def: 'Gifts & Goodies' },
